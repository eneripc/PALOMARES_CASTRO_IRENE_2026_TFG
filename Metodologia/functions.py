...
#data = (VARIANTE, CLASE, STATUS, FECHA_PARTIDAS_LOW, FECHA_PARTIDAS_HIGH, SOCIEDAD ) =   [("PAG_MASTER", "3", "1", "2025-11-10", "2025-11-10", "2214"),(),(),...]

def fbl1n(data, carpeta=str, base_dir ="."):

    #fechas = pd.date_range("2024-01-26", "2026-01-26", freq="ME")
